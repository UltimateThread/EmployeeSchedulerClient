$(document).ready(function () {
  ...
  //  $.getJSON("http://localhost:60245/api/PullEvents/GetEvents", function(eventsResponse) {
  //    eventsList = eventsResponse.events;
  //  })
  //  .done(function() {
  //    console.log(eventsList);
  //       var json = JSON.stringify(eventsList);
  //       var jsonData = JSON.parse(json);
  //       for (var i = 0; i < jsonData.eventsList.length; i++) {
  //       var counter = jsonData.eventsList[i];
  //       console.log(eventsList.title);
  //       }
  //     //  console.log(eventsList[index].id);
  //     //  console.log(orderId);
  //  });
